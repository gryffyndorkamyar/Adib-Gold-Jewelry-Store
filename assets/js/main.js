...
(function () {
    ...
    Riode.degree360 = function (selector) {
        ...
        //         {
        //             totalFrames: images.length, // Total no. of imageشما دارید for 360 slider
    ...
    Riode.initProductSingle = (function () {
        ...
        ProductSingle.prototype.variationMatch = function () {
            var self = this;
            self.$priceWrap.find('span').text((Math.round(Math.random() * 50) + 200) + ',000 تومان');
        ...
        function initWishlistAction(e) {
            ...
            setTimeout(function () {
                $this
                    ...
                    .html('<i class="d-icon-heart-full"></i> لیست علاقه مندی')
                    .addClass('added')
                    .attr('title', 'اضافه به علاقه مندی ')
        ...
        initWishlistButton: function (selector) {
            Riode.$body.on('click', selector, function (e) {
                ...
                setTimeout(function () {
                    ...
                    if ($this.hasClass('added')) {
                        $this.attr('title', 'حذف از علاقه مندی');
                    } else {
                        $this.attr('title', 'اضافه به علاقه مندی');
                    }
                }, 500);
                e.preventDefault();
            })
    ...
    Riode.init = function () {
        Riode.appearAnimate('.appear-animate');                               // اجراها انیمیشن ها ظاهر می شوند
